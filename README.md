...
Note: You can name your key *anything you want* as long as it starts with `REACT_APP` and is in **SCREAMING_SNAKE_CASE** without any spaces.
...
- `Home.js` will need 3 methods and an instance of `useEffect` to fire one of its 3 methods, which will access our API when the component *is mounted*.
...
- Pull request utilizing this template: [PR Guidelines](https://github.com/SEI-R-9-19/template_pull_request)
